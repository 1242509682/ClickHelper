...
internal class Config
{
    ...
    [JsonProperty("自动加载OCR", Order = -10)] public bool AutoLoadOcr { get; set; } = true;
    ...
    [JsonProperty("定时模式", Order = 6)] public int TimerMode { get; set; } = 0;
    ...
    [JsonProperty("定时时长", Order = 9)] public int TimerDuration { get; set; } = 60;
    [JsonProperty("定时目标", Order = 10)] public int TimeType { get; set; } = 0;
    ...
    [JsonProperty("截图热键", Order = 22)] public int SnapHotKey { get; set; } = (int)Keys.A;

    [JsonProperty("坐标管理表", Order = 23)] public List<PosData> PosList { get; set; } = new();
    ...
    public class PosData
    {
        ...
        [JsonProperty("匹配阈值")] public float Threshold { get; set; } = 0.6f;
        [JsonProperty("使用文字")] public bool UseTxt { get; set; } = false;
        [JsonProperty("匹配文字")] public string? TxtMatch { get; set; }
        [JsonProperty("文字模式")] public int TxtMode { get; set; } = 0;
        [JsonProperty("文字阈值")] public float TxtThresh { get; set; } = 0.5f;

        [JsonProperty("启用UIA")] public bool UseUIA { get; set; } = false;
        [JsonProperty("UIA进程")] public string UIAProc { get; set; } = "";
        [JsonProperty("文本内容")] public string TextContent { get; set; } = ""; // 自动输出文本
        [JsonProperty("组合键")] public string ComboKeys { get; set; } = "Ctrl+C";
    }
